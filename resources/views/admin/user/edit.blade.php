                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-lg-4 col-sm-6">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="Password" id="password" class="form-control" name="password"value="{{ $datauser->password}}">
                                    </div>
                                ...
                                <div class="col-lg-4 col-sm-12">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="password" id="password_confirmation" class="form-control" required name="password_confirmation"value="{{ $datapassword_confirmation->password_confirmation }}">
                                    </div>
